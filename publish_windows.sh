...
./exe_set_subsystem.py "SS14.Launcher/bin/Release/net7.0/win-x64/publish/SSMV.Launcher.exe" 2
...
cp "SS14.Launcher.Bootstrap/bin/Release/net45/publish/Space Station Multiverse Launcher.exe" bin/publish/Windows
